...
// Colors
const Color kBlue = Color(0xFF1CA0FF);
const Color kLightBlue = Color(0xFF45B0FF);
const Color kDarkBlue = Color(0xFF008DF4);
const Color kWhite = Color(0xFFFFFFFF);
const Color kGrey = Color(0xFFF4F5F7);
const Color kBlack = Color(0xFF2D3243);
const Color kDarkGrey = Color(0xFF9597A1);
const Color kDGrey = Color(0xFF8D8E96);
...
const String kLogoBlue = 'assets/images/logo-blue.png';
const String kLogoWhite = 'assets/images/logo-white.png';